...
export class EtmiPlusClient {
     ...
     * @return Success
     */
    parametrica(id: number, cancelToken?: CancelToken | undefined): Promise<void> {
     ...
     * @return Success
     */
    reporteBinomioGET(idGestanteControl: number, cancelToken?: CancelToken | undefined): Promise<void> {
     ...
     * @return Success
     */
    reporteEAPBGET(idGestanteControl: number, cancelToken?: CancelToken | undefined): Promise<void> {
     ...
     * @return Success
     */
    reporteEAPBPOST(idGestanteControl: number, body?: ReporteEAPB | undefined, cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/GestanteControl/{idGestanteControl}/ReporteEAPB";
        if (idGestanteControl === undefined || idGestanteControl === null)
            throw new Error("The parameter 'idGestanteControl' must be defined.");
        url_ = url_.replace("{idGestanteControl}", encodeURIComponent("" + idGestanteControl));
     ...
     * @return Success
     */
    sifilis(idGestanteControl: number, cancelToken?: CancelToken | undefined): Promise<void> {
